(() => {
  ...
  const preferToggle = e => {
    ...
    var theme = document.querySelector("body").getAttribute("data-md-color-scheme") === "slate" ? "https://gcore.jsdelivr.net/gh/cxzhou35/notebook/docs/_css/giscus.css" : "light"
...
window.toggleScheme = () => {
  ...
  var frame = document.querySelector(".giscus-frame")
  var theme = scheme === "slate" ? "https://gcore.jsdelivr.net/gh/cxzhou35/notebook/docs/_css/giscus.css" : "light"
  frame.contentWindow.postMessage(
    { giscus: { setConfig: { theme } } },
    "https://giscus.app"
  )
